...
IndicadoresexcluidosNew <- c("ubigeo", "ccdd", "ccpp", "ccdi", "departamento", "provincia", "distrito")
                          ...
                          mainPanel(
                            div(
                              ...
                              layout_columns(
                                value_box(
                                  textOutput("dato1"),
                                  title = "Déficit habitacional - INEI",
                                  showcase = icon("house", size = 100),
                                  showcase_layout = "left center",
                                  theme_color = "secondary"),
                                value_box(
                                  textOutput("dato2"),
                                  title = "Déficit cuantitativo - INEI",
                                  showcase = icon("house", size = 100),
                                  showcase_layout = "left center",
                                  theme_color = "secondary"),
                                value_box(
                                  textOutput("dato3"),
                                  title = "Déficit cualitativo - INEI",
                                  showcase = icon("house", size = 100),
                                  showcase_layout = "left center",
                                  theme_color = "secondary")
                              )
                            ...
                            #    value_box(
                            #      textOutput("dato4"),
                            #      title = "Déficit habitacional - Nueva Metodología",
                            #      showcase = icon("house", size = 100),
                            #      showcase_layout = "left center",
                            #      theme_color = "success"),
                            #    value_box(
                            #      textOutput("dato5"),
                            #      title = "Déficit cuantitativo - Nueva Metodología",
                            #      showcase = icon("house", size = 100),
                            #      showcase_layout = "left center",
                            #      theme_color = "success"),
                            #    value_box(
                            #      textOutput("dato6"),
                            #      title = "Déficit cualitativo - Nueva Metodología",
                            #      showcase = icon("house", size = 100),
                            #      showcase_layout = "left center",
                            #      theme_color = "success")
                            #  )
...
## Present provincias depending on the selected departamento and distritos depending on the selected provincia.
  ...
  output$dato1 <- renderPrint({
    ...
    if (input$Dpto != "TODOS" & input$Prov != "TODOS" & input$Dist != "TODOS"){
      ...
      formatted_value <- paste(format(valor, big.mark = ",", decimal.mark = "."))
